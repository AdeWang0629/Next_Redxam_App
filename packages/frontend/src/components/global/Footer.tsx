    ...
    <footer className='pt-16 bg-footer-bg px-4 md:px-0'>
      ...
      <div className='flex flex-col items-center justify-center lg:px-64'>
        <span className='text-center font-primary text-black text-opacity-50'>
          REDXAM FZCO is a company registered in Dubai Silicon Oasis with
          company number DSO-FZCO-11626. Registered office: 38th Floor, Media
          One Hotel - Office Tower, Dubai Media City, PO Box 334069, Dubai,
          United Arab Emirates.
        </span>
        <span className='text-center font-primary text-black text-opacity-50'>
          REDXAM LLC is a company registered in the United States with company
          number 0450552953. Registered office: 90 Church St., Unit 3028, New
          York, NY 10008, United States of America.
        </span>
