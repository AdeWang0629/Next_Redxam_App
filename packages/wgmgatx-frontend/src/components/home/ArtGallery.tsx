...
const ArtGallery = (props: Props) => {
  ...
  return (
    ...
    <div className='bg-white'>
      <h1 className="text-2xl font-bold mt-16 mb-10 ml-[10%]">
          Gallery
      </h1>
      <div>
          <div className="relative grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 gap-2 col-span-3 mx-[10%] pb-6">
                ...
                return(
                  <div className="m-4" key={index}>
                    <Image 
                      ...
                      />
                    <div id={art.id} className='bg-[#41414959] text-left p-8 w-4/5 rounded-[15px] mx-auto transition duration-150 ease-in-out z-30 translate-y-[-150px]'>
            ...
            <div id="btn" className="absolute bottom-0 right-12 transition duration-150 ease-in-out" onMouseOver={() => btnZoomIn()} onMouseOut={() => btnZoomOut()}>
              <Link href='/gallery'>
