  ...
  <>
    ...
    <main className="flex flex-col space-y-6 pt-44 pb-20 max-w-3xl lg:max-w-4xl xl:max-w-7xl mx-auto leading-[1.8] font-primary text-black dark:text-white text-opacity-80 text-[1.0625rem]">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <h2 className="text-xl font-semibold font-secondary">Interpretation</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold font-secondary">Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to redxam llc, Unit 1620, Park Regis,
              Dubai.
            </p>
          </li>
          <li>
      ...
      <div className="flex flex-col space-y-2">
        ...
        <h3 className="text-lg font-medium font-secondary">Personal Data</h3>
        <p>
        ...
        <h3 className="text-lg font-medium font-secondary">Usage Data</h3>
        ...
        <h3 className="text-lg font-medium font-secondary">
        ...
        <h3 className="text-lg font-medium font-secondary">Law enforcement</h3>
        <p>
      ...
      <div className="flex flex-col space-y-2">
        <h1 className="text-2xl font-bold font-secondary">Contact Us</h1>
        <p>
        ...
        <ul>
          <li>
            By email:{' '}
            <a href="mailto:support@redxam.com" className="underline">
              support@redxam.com
            </a>
          </li>
        </ul>
