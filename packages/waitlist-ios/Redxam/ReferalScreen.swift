...
//  Redxam
//
//  Created by Priyanka Dadhich on 3/11/22.
//

import SwiftUI

struct ReferalScreen: View {
        ...
        ZStack(alignment:.topLeading) {
            ...
            if UIDevice.current.userInterfaceIdiom == .pad {
                ...
                Image("bg_bottom_left_gray" )
                    .offset(x: 0, y: ContentView.screenHeight-170)
                    .edgesIgnoringSafeArea(.all)
                ...
                Image("bg_bottom_left_gray_small" )
                    .offset(x: 10, y: ContentView.screenHeight-90)
                    .edgesIgnoringSafeArea(.all)
            }
...
//                    .cornerRadius(30)
            ...
            if UIDevice.current.userInterfaceIdiom == .pad {
                ...
                HStack(alignment: .center){
                    ...
                    }.frame(width: ContentView.screenWidth * 0.7, alignment: .center)
...
//            Button(action: { print("hello") }, label: { Text("Button") })
            ...
            NavigationLink(destination: BuyScreen()) {
           
                HStack {
                    
                    Text("redxam.com?referral=max")
        ...
        }.frame(width: ContentView.screenWidth*0.9, height: ContentView.screenHeight*0.8)
                .padding(40)
        }
...
struct ReferalScreen_Previews: PreviewProvider {
